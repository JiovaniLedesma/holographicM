...
class GUI(Tk):
  def __init__(self, *args, **kwargs):
    ...
    #                LABEL PARA AXES 2
    #*******************************************************************************************************************
    Label(frame2, text = "Fase\n(Espectro de Fourier)", font = Arial12, bg = color_background).grid(row = 1, column = 2, padx = 5, pady = 5)
    #*******************************************************************************************************************
    ...
    btn_reconstruir = Button(frame2, text = "Reconstruir", font = Arial11, width = 9, height = 1, borderwidth = 2, cursor = "hand2")
    ...
    btn_salir = Button(frame2, text = "Salir", font = Arial11, width = 9, height = 1, borderwidth = 2, cursor = "hand2", command = self.main.destroy)
